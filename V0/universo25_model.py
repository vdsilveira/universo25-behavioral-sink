...
MATERNAL_AGGRESSION_THRESHOLD = 0.40
SOCIAL_DAMAGE_INHERITANCE = 0.25
SOCIAL_DAMAGE_BIRTH_FACTOR = 1.0
SOCIAL_DAMAGE_WEANING_RATE = 0.03
...
COLONY_STRESS_DIVISOR = 3000  # população que equivale a 50% do estresse da colônia
