...
with st.sidebar:
    ...
    stress_gain = st.slider("Ganho de estresse",
                            0.01, 0.15, STRESS_GAIN_RATE, 0.005,
                            format="%.3f",
    ...
    sd_birth_factor = st.slider("Fator dano social ao nascer",
                                1.0, 3.0, SOCIAL_DAMAGE_BIRTH_FACTOR, 0.1,
                                help="Multiplica o colony_stress no social_damage do filhote. "
                                     "1.3 = calibrado V0.1.")
